...
from db.tables import DataAcquisitionDetailsSoupKitchen
from db.tables import DataAcquisitionDetailsToilet
from db.tables import DataAcquisitionLocations
